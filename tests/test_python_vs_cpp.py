    ...
    def test_post_ibp(self, NL):
        ...
        for E_kev, Ep_kev, xi, T_kev in TEST_POINTS:
            ...
            py_val, py_aerr, py_rerr = py_sigma_E(
                E, Ep, xi, T, 1.0, form="post_ibp", NL=NL, method="fixed"
            )
    ...
    def test_pre_ibp(self, NL):
        ...
        for E_kev, Ep_kev, xi, T_kev in TEST_POINTS:
            ...
            py_val, _, _ = py_sigma_E(
                E, Ep, xi, T, 1.0, form="pre_ibp", NL=NL, method="fixed"
            )
    ...
    def test_error_estimates_same_order(self):
        ...
        for E_kev, Ep_kev, xi, T_kev in TEST_POINTS:
            ...
            assert ratio > 0.01, (
                ...
                f"E={E_kev}, Ep={Ep_kev}, xi={xi}, T_kev={T_kev}: "
...
class TestAdaptiveDiagnostic:
    ...
    def test_post_ibp_adaptive(self):
        ...
        for E_kev, Ep_kev, xi, T_kev in TEST_POINTS:
            ...
            cpp_r = cpp_engine.sigma_E(E, Ep, xi, T, 1.0)
            py_val, _, _ = py_sigma_E(
                E, Ep, xi, T, 1.0, form="post_ibp", method="adaptive"
            )
    ...
    def test_pre_ibp_adaptive(self):
        ...
        for E_kev, Ep_kev, xi, T_kev in TEST_POINTS:
            ...
            cpp_r = cpp_engine.sigma_E(E, Ep, xi, T, 1.0)
            py_val, _, _ = py_sigma_E(
                E, Ep, xi, T, 1.0, form="pre_ibp", method="adaptive"
            )
